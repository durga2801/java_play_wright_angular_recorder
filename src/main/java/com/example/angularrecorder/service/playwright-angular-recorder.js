(() => {
    ...
    function isSharedContainer(element) {
        ...
        return (
            ...
            className.includes('dropdown-panel') ||
    ...
    function findLogicalAngularHost(
        ...
        /*
         * Always prefer the binding on the actual element.
         * Two controls can use the same component/input type, so identity
         * must come from the concrete field that received the event.
         */
        if (hasControlBinding(nativeElement)) {
            return nativeElement;
        }

        /*
         * Walk only through the actual element's DOM ancestors.
         * Do not merge composedPath() with a second ancestor list here;
         * reusable Angular components and overlays can otherwise make
         * different visible fields resolve to the same shared host.
         */
        let current =
        ...
        /*
         * If there is no exposed Angular binding, use the nearest custom
         * component only. Shared overlay/popup containers are never a field.
         */
        current =
            nativeElement.parentElement;
    ...
    function controlName(
        ...
        /*
         * Prefer the OUTER bound logical component. Internal text/search
         * inputs are frequently identical across multiple custom controls.
         */
        const elements = [
            customHost,
            nativeElement
    ...
    function semanticInputName(
        ...
        /*
         * Bound field identity must win over a reusable visible label such
         * as Search/Select. This keeps variables unique for same-type fields.
         */
        return clean(
            c.FORM_CONTROL_NAME ||
            c.CONTROL_NAME ||
    ...
    function identifyBy(
        ...
        /*
         * Prefer field-specific attributes before shared labels/roles.
         * This prevents two AUTOCOMPLETE/SELECT/DATE/etc. fields from
         * receiving an identical identifyBy just because their internal
         * implementation uses the same label, role or search input.
         */
        const priority = [
            'FORM_CONTROL_NAME',
            'CONTROL_NAME',
